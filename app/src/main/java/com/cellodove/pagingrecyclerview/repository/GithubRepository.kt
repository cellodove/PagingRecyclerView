package com.cellodove.pagingrecyclerview.repository

import android.util.Log
import com.cellodove.pagingrecyclerview.model.GithubRepo
import com.cellodove.pagingrecyclerview.model.RepoSearchResult
import com.cellodove.pagingrecyclerview.repository.api.GithubService
import com.cellodove.pagingrecyclerview.repository.api.IN_QUALIFIER
...
class GithubRepository(private val service: GithubService) {
    ...
    private fun reposByName(query: String): List<GithubRepo> {
        ...
        }.sortedWith(compareByDescending<GithubRepo> { it.stars }.thenBy { it.name })
    }
